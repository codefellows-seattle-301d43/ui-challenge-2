...
- Create a new repository called ***ui-challenge-2*** for your work.
...
- You should NOT use the comps within your site, but you should ABSOLUTELY use the sprites within your site.
